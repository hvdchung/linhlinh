document.addEventListener("DOMContentLoaded", function () {
  var w = (c.width = window.innerWidth),
    ...
    opts = {
      ...
      gravity: 0.1,
      upFlow: -0.1,
      letterContemplatingWaitTime: 680,
      balloonSpawnTime: 20,
      balloonBaseInflateTime: 500,
      balloonAddedInflateTime: 500,
      balloonBaseSize: 20,
      balloonAddedSize: 20,
      balloonBaseVel: 0.4,
      balloonAddedVel: 0.4,
  ...
  function anim() {
    ...
    if (done) {
      const hidecake = document.querySelector("#cakes");
      hidecake.style.display = "block";
      const hidden_done = document.querySelector("body");
      hidden_done.classList.add("active");
    }
  }

  function startBirthdayAnimation() {
    const hidecake = document.querySelector("#cakes");
    hidecake.style.display = "none";
  ...
  // Countdown to birthday and conditional animation
  const countdownEl = document.createElement("div");
  countdownEl.id = "countdown";
  // countdownEl.style.position = "absolute";
  // countdownEl.style.top = "20px";
  countdownEl.style.textAlign = "center";
  countdownEl.style.font = "20px Verdana";
  ...
  function updateCountdown() {
    ...
    countdownEl.innerHTML = `
        <span class="count-box"><span class="count-num">${days}</span><span class="count-label">D</span></span>
        <span class="count-box"><span class="count-num">${hours}</span><span class="count-label">H</span></span>
        <span class="count-box"><span class="count-num">${minutes}</span><span class="count-label">M</span></span>
        <span class="count-box"><span class="count-num">${seconds}</span><span class="count-label">S</span></span>
      `;
  }
  ...
  function checkBirthdayTrigger() {
    ...
    if (
      ...
      updateCountdown();
      setTimeout(checkBirthdayTrigger, 1000);
    }
  }
...
function createSnowflakes(count = 100) {
  ...
  container.innerHTML = ""; // clear old flakes if any
  ...
  for (let i = 0; i < count; i++) {
    ...
    const xDrift = (Math.random() - 0.5) * 100 + "px";
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Optional: Recreate snowflakes every 20 seconds for variation
  setInterval(() => {
    createSnowflakes(100);
  }, 20000);
});
